...
export function serialize(value) {
    ...
    if (typeof value === "number") {
        if (!Number.isFinite(value)) {
            throw new PGSnapSerializationError("Cannot serialize non-finite number values.");
        }
    ...
    if (typeof value === "object") {
        try {
            ...
            throw new PGSnapSerializationError(`Failed to serialize value: ${err.message}`);
        }
    }
    throw new PGSnapSerializationError(`Cannot serialize value of type ${typeof value}.`);
}
