...
import type { ModelSchema, SchemaField, ModelState } from "./types.js";
 ...
 */
export function validateDocument(schema: ModelSchema, doc: Record<string, any>, isUpdate = false): void {
 ...
 */
export function applyDefaults(schema: ModelSchema, doc: Record<string, any>): Record<string, any> {
  const result = { ...doc };
  for (const [field, def] of Object.entries(schema)) {
 ...
 */
export function documentToRow(schema: ModelSchema, doc: Record<string, any>): Record<string, any> {
 ...
 */
export function buildColumnMap(schema: ModelSchema): Map<string, string> {
 ...
 */
export function getPrimaryKey(schema: ModelSchema): string {
