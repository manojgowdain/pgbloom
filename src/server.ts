/**
 * Server-only entry point for PGBloom.
 *
 * This module exports the full PGBloom API including PostgreSQL-backed features.
 * Only use in server environments (Node.js, Bun, Deno with Node compat).
 *
 * Browser applications should NOT import this directly. Instead, access
 * server features via HTTP/RPC to a backend server running PGBloom.
 *
 * @module pgbloom/server
 */

// Main client - requires PostgreSQL
